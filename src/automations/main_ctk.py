...
class LogLifeApp(ctk.CTk):
    ...
    def __init__(self):
        ...
        # configure window
        self.title(f'Operação LogLife - {get_version_info()}')
        ...
        # Check for updates on startup (after UI is created)
        self.after(1000, self.version_manager.auto_check_on_startup)
    ...
    def create_frames(self):
        ...
        tab5_frame = ctk.CTkFrame(self.tab5)
        ...
        tab4_frame.pack()
        tab5_frame.pack(pady=20, padx=20, fill="both", expand=True)
        ...
        # Tab 5 - About/Update Section
        
        # Version info
        version_label = ctk.CTkLabel(
            tab5_frame,
            text=get_version_info(),
            font=("Arial", 16, "bold")
        )
        ...
        desc_label = ctk.CTkLabel(
            tab5_frame,
            text="Sistema de Automação LogLife\nOperações de Coleta, Embarque e Entrega",
            font=("Arial", 12)
        )
        ...
        update_button = ctk.CTkButton(
            ...
            command=self.version_manager.force_update_check,
            width=200,
            height=40,
            font=("Arial", 12, "bold")
        )
        ...
        info_label = ctk.CTkLabel(
            tab5_frame,
            text="Desenvolvido para LogLife\n© 2025 - Todos os direitos reservados",
            font=("Arial", 10),
            text_color="gray"
        )
        info_label.pack(pady=10, side=BOTTOM)
